...
const INGREDIENTS = [
  ...
  },
  {
    ...
    studies: [
      { title: "Cordyceps-Containing Blend and Exercise Tolerance", authors: "Hirsch et al.", journal: "J Dietary Supplements", year: 2017, finding: "A 4 g/day multi-mushroom blend containing C. militaris had limited between-group effects after one week; an exploratory 10-person subgroup showed improved VO2max after three weeks. BrewNectar's ingredient and dose differ.", url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC5236007/" },
    ],
  },
  {
...
const COMPOUNDING_STAGES = [
  { period: "Day 1", title: "Your Coffee Feels More Dialed In", level: "40%", desc: "L-Theanine and Alpha-GPC are the first-cup ingredients: one supports calm attention alongside caffeine, while the other provides choline used to make acetylcholine. B6 + B12 support normal energy metabolism and nervous-system function from day one.*", ingredients: ["L-Theanine", "Alpha-GPC", "B6 + B12"], color: "bg-amber-50 border-amber-200", iconColor: "text-[#D97706]", dotColor: "bg-[#D97706]" },
  { period: "Week 2", title: "Your Gut-Brain Routine Is Underway", level: "60%", desc: "Inulin is feeding beneficial gut bacteria each day, while B. coagulans adds probiotic support. Human gut-brain studies typically measure outcomes over four to twelve weeks, so Week 2 is the foundation-building phase — not the finish line.*", ingredients: ["Prebiotic Inulin", "B. coagulans"], color: "bg-emerald-50 border-emerald-200", iconColor: "text-emerald-600", dotColor: "bg-emerald-600" },
  { period: "Week 6", title: "Steadier Energy Has Had Time to Build", level: "80%", desc: "Rhodiola has crossed the 28-day window used in a trial on stress-related fatigue and attention. A Cordyceps-containing blend showed exercise-tolerance gains after three weeks. Together, they support the longer, steadier side of daily energy — not another caffeine spike.*", ingredients: ["Rhodiola", "Cordyceps"], color: "bg-sky-50 border-sky-200", iconColor: "text-sky-600", dotColor: "bg-sky-600" },
  { period: "Week 12", title: "Long-Horizon Support Is In View", level: "95%", desc: "Ashwagandha and Lion's Mane have now had the kind of multi-week runway used in human sleep, stress, and cognition studies. This is the right point to judge the full routine — not a single cup.*", ingredients: ["Ashwagandha", "Lion's Mane"], color: "bg-violet-50 border-violet-200", iconColor: "text-violet-600", dotColor: "bg-violet-600" },
];
            ...
            <div className="relative mx-auto mt-20 max-w-3xl overflow-visible rounded-2xl border border-stone-200 bg-white shadow-[0_12px_35px_rgba(68,64,60,0.08)] sm:mt-0">
              ...
              <div className="relative grid min-h-[58px] grid-cols-[minmax(0,1fr)_80px_94px] md:min-h-0 md:grid-cols-[minmax(0,1fr)_120px_140px]">
                <div className="relative flex items-end justify-center px-3 pb-2 md:block md:px-5 md:py-4">
                  <img src="/manus-storage/comparison-brewnectar-user_16c697c8.png" alt="" aria-hidden="true" className="absolute -top-[72px] left-1/2 h-[132px] w-[198px] max-w-none -translate-x-1/2 object-contain drop-shadow-md sm:hidden" />
                </div>
