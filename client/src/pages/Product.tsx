          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <FadeUp delay={0.1}>
              <div>
                ...
                {/* Shipping notice with urgency badge */}
                <div className="mt-4 flex items-center justify-center gap-2 flex-wrap">
                  <span className="text-xs text-[#78716C]">Ships to United States in 4–5 days</span>
                  <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-amber-100 border border-amber-200/80">
                    <span className="relative flex h-1.5 w-1.5">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-amber-500 opacity-75"></span>
                      <span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-amber-500"></span>
                    </span>
                    <span className="text-[10px] font-bold text-[#B45309] uppercase tracking-wide">Faster Shipping due to high demand</span>
                  </span>
                </div>
                ...
                <div className="mt-6 border-t border-stone-200 pt-5">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-semibold text-[#1C1917]">4.9</span>
                      <span className="text-xs text-[#78716C]">(2,400+ reviews)</span>
                    </div>
                  </div>
                    ...
                    {[
                      {
                        ...
                        tag: "Verified Buyer",
                        days: "3 days ago",
                        text: "I've tried every nootropic on the market. This is the first one I actually feel working within 20 minutes. My afternoon slump is gone.",
                        rating: 5,
                      },
                      {
                        name: "James K.",
                        tag: "Verified Buyer",
                        days: "1 week ago",
                        text: "Switched from Ryze mushroom coffee. Night and day difference — no gritty taste, just smooth vanilla in my espresso with real focus.",
                        rating: 5,
                      },
                      {
                        name: "Dr. Lisa T.",
                        tag: "Verified Buyer",
                        days: "2 weeks ago",
                        text: "As a physician, I'm picky about what I put in my body. Clean label, clinically-dosed Cognizin, and it actually tastes great. Subscribed to the 3-bottle plan.",
                        rating: 5,
                      },
                    ].map((review, i) => (
                      <div key={i} className="bg-stone-50 rounded-xl p-3.5 border border-stone-100">
                        <div className="flex items-center justify-between mb-1.5">
                          <div className="flex items-center gap-2">
                            <div className="w-7 h-7 rounded-full bg-gradient-to-br from-amber-200 to-amber-400 flex items-center justify-center text-[10px] font-bold text-white">
                              {review.name.charAt(0)}
                            </div>
                            <div>
                              <span className="text-xs font-semibold text-[#1C1917]">{review.name}</span>
                              <span className="ml-1.5 text-[10px] px-1.5 py-0.5 rounded-full bg-emerald-50 text-emerald-700 font-medium border border-emerald-100">{review.tag}</span>
                            </div>
                          </div>
                          <span className="text-[10px] text-[#A8A29E]">{review.days}</span>
                        </div>
                        ...
                        <p className="text-xs text-[#57534E] leading-relaxed">{review.text}</p>
                      </div>
                    ))}
                  </div>
                  ...
                  <button
                    ...
                    className="mt-3 w-full text-center text-xs font-medium text-[#B45309] hover:text-[#92400E] transition-colors cursor-pointer"
                  >
